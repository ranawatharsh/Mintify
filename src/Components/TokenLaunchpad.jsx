...
export function TokenLaunchpad() {
    ...
    <div className="flex flex-col space-y-5 border-gray-300 p-30 rounded-2xl shadow-xl bg-[#ffffff53] backdrop-blur-md w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-2/5">
