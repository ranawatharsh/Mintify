...
export function TokenLaunchpad() {
    ...
    <div className="flex flex-col space-y-5 border-gray-300 p-30 rounded-2xl shadow-xl bg-[rgba(255,255,255,0.80)] backdrop-blur-sm w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-2/5">
      <h2 className="text-3xl font-bold mb-4 text-center text-gray-900">Create Your Token</h2>
