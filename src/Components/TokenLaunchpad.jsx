...
export function TokenLaunchpad() {
    ...
    <div className="flex flex-col space-y-5 border-gray-700 p-30 rounded-lg shadow-2xl bg-[rgba(15,20,40,0.82)] backdrop-blur-md w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-2/5">
      <h2 className="text-3xl font-bold mb-4 text-center text-white">Create Your Token</h2>
